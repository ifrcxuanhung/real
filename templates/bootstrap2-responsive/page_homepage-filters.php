...
<div class="container">
    ...
    <div class="results-properties-list with-sidebar">
        ...
        <div class="filter-checkbox-container">
            ...
            <div class="row">
                ...
                <div class="span12">
                <select option_id="59" rel="to" class="span12 nomargin selectpicker input_am_to id_59_to" placeholder="{options_name_59}">
    ...
    <?php _subtemplate('footers', _ch($subtemplate_footer, 'contact_logo_share')); ?>
