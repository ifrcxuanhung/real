...
class Profile extends Frontend_Controller
{
    ...
    public function index()
    {
        ...
        //TODO: Memory usage should be reduced on large number of properties (10k properties = 5MB usage reduction)
        //if(false)
        ...
        /* START Get agent estates */
        $estates = $this->estate_m->get_by($where, FALSE, 100, NULL, NULL, array(), NULL,  $agent['id']);
        $this->data['search_purpose'] = NULL;
