...
class Estate extends Admin_Controller
{
    ...
    public function index($pagination_offset=0)
	{
        ...
        prepare_search_query_GET(array('field_2', 'field_4'), array('id', 'address', 'search_values'));
    ...
    public function edit($id = NULL)
	{
        ...
        if($this->form_validation->run() == TRUE)
        {
            ...
            if($this->session->userdata('type') == 'AGENT_LIMITED' && $this->data['settings']['email_alert'] == 1)
            {
